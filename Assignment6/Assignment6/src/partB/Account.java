...
public class Account
{
    ...
    {
        return CurBalance= CurBalance-debitAmount;
...
/****
 * Console Result
Account name: John Smith, Account Type: partB.Account, Balance: $100.00
Account name: John Smith, Account Type: partB.Account, Balance: $69.75
Account name: John Smith, Account Type: partB.Account, Balance: $79.85
 * 
 * ***/
